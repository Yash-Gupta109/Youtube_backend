...
const generateAccessAndRefereshTokens = async (userId) => {
    try {
        ...
        throw new ApiError(500, "Semething went wrong while generating access and referesh token")
    }
}
...
const changeCurrentPassword = asyncHandler( async(req, res) => {
    ...
    const user = await User.findById(req.user?._id) //check here for _id or id
